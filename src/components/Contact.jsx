        ...
        return (
            <div name="contant" className="w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white">
                <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
                    ...
                    <div>
                        <form action="https://getform.io/f/9f62bd7f-2d01-46f5-969b-cd7d3aa49526" method="post" className="flex flex-col w-full md:w-1/2">
                            <input
                             id='intro'
                             type="text"
                             name="name"
                             placeholder="Enter your name"
                             className="p-2 bg-transparent border-2 rounder-md
